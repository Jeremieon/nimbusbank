...
#
# Multi-currency demo: each user's two accounts share one currency — admin
# and alice USD, bob EUR, carol GBP, dave JPY. A transfer between accounts of
# different currencies converts via services/accounts/app/fx.py.
SEED_ACCOUNTS = [
    # Nimbus Admin (USD)
    {"user_id": "11111111-1111-1111-1111-111111111111", "account_number": "NB-1000-0001", "account_type": "checking",
     "balance_cents": 542_311, "currency": "USD", "dob": date(1985, 3, 12), "ssn_full": "123-45-6789"},
    {"user_id": "11111111-1111-1111-1111-111111111111", "account_number": "NB-1000-0002", "account_type": "savings",
     "balance_cents": 1_200_000, "currency": "USD", "dob": date(1985, 3, 12), "ssn_full": "123-45-6789"},
    # Alice Nguyen (USD)
    {"user_id": "22222222-2222-2222-2222-222222222222", "account_number": "NB-2000-0001", "account_type": "checking",
     "balance_cents": 184_522, "currency": "USD", "dob": date(1990, 7, 24), "ssn_full": "234-56-7890"},
    {"user_id": "22222222-2222-2222-2222-222222222222", "account_number": "NB-2000-0002", "account_type": "savings",
     "balance_cents": 950_000, "currency": "USD", "dob": date(1990, 7, 24), "ssn_full": "234-56-7890"},
    # Bob Martinez (EUR)
    {"user_id": "33333333-3333-3333-3333-333333333333", "account_number": "NB-3000-0001", "account_type": "checking",
     "balance_cents": 67_140, "currency": "EUR", "dob": date(1988, 11, 2), "ssn_full": "345-67-8901"},
    {"user_id": "33333333-3333-3333-3333-333333333333", "account_number": "NB-3000-0002", "account_type": "savings",
     "balance_cents": 302_218, "currency": "EUR", "dob": date(1988, 11, 2), "ssn_full": "345-67-8901"},
    # Carol Odom (GBP)
    {"user_id": "44444444-4444-4444-4444-444444444444", "account_number": "NB-4000-0001", "account_type": "checking",
     "balance_cents": 998_431, "currency": "GBP", "dob": date(1979, 5, 30), "ssn_full": "456-78-9012"},
    {"user_id": "44444444-4444-4444-4444-444444444444", "account_number": "NB-4000-0002", "account_type": "savings",
     "balance_cents": 4_500_000, "currency": "GBP", "dob": date(1979, 5, 30), "ssn_full": "456-78-9012"},
    # Dave Kowalski (JPY)
    {"user_id": "55555555-5555-5555-5555-555555555555", "account_number": "NB-5000-0001", "account_type": "checking",
     "balance_cents": 12_045, "currency": "JPY", "dob": date(1995, 1, 18), "ssn_full": "567-89-0123"},
    {"user_id": "55555555-5555-5555-5555-555555555555", "account_number": "NB-5000-0002", "account_type": "savings",
     "balance_cents": 88_760, "currency": "JPY", "dob": date(1995, 1, 18), "ssn_full": "567-89-0123"},
]
